...
DXA Agent moves quickly: multi-provider CLI, local backends, MCP, terminal-first. I merge patches that are focused, tested, and easy to review.

## Before You Start

- Skim [LEGAL.md](LEGAL.md) so you know how this repo handles copyright, third-party code, and trademarks (quick read).
- Search existing [issues](https://github.com/dxiv/dxa-agent/issues) and [discussions](https://github.com/dxiv/dxa-agent/discussions) before opening a new thread.
