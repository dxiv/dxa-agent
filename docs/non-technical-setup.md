# DXA Agent for Non-Technical Users
...
DXA Agent lets you use an AI coding assistant with different model providers such as:
...
After you run `dxa-agent`, the CLI should start and wait for your prompt.
