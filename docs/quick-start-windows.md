...
**Other paths:** [Non-technical walkthrough](non-technical-setup.md) · [macOS / Linux](quick-start-mac-linux.md) · [Advanced / source build](advanced-setup.md) · [Troubleshooting](troubleshooting.md) · [npm package](https://www.npmjs.com/package/@dxa-dev/agent)
