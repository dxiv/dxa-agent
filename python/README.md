...
These modules are **not** required to install or run the main **DXA Agent** CLI ([**`@dxa-dev/agent`**](https://www.npmjs.com/package/@dxa-dev/agent): `npm install -g @dxa-dev/agent`, or a normal `bun` source build).
