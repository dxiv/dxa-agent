...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: ('external' as string) === 'ant' ? "Deimos Updates [internal-only: Latest CC commits]" : "Deimos Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share Deimos and earn ${formatCreditAmount(reward)} of extra usage` : 'Share Deimos with friends';
  return {
