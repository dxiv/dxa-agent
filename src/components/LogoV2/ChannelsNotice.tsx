...
import { getDeimosCloudOAuthTokens, getSubscriptionType } from '../../utils/auth.js';
...
export function ChannelsNotice() {
  ...
  if (noAuth) {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
      t2 = <Text dimColor={true}>Channels require github.com/dxiv/dxa-deimos authentication · run /login, then restart</Text>;
      $[9] = t2;
    } else {
      t2 = $[9];
    }
  ...
  let t2;
  if ($[24] !== flag) {
    t2 = <Text dimColor={true}>Experimental · inbound messages will be pushed into this session, this carries prompt injection risks. Restart Deimos without {flag} to disable.</Text>;
    $[24] = flag;
    $[25] = t2;
  } else {
    t2 = $[25];
...
function _temp() {
  ...
  return {
    ...
    noAuth: !getDeimosCloudOAuthTokens()?.accessToken,
