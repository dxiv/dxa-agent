...
const GITHUB_ISSUES_REPO_URL = 'https://github.com/dxiv/dxa-deimos/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Deimos&apos;s functionality (eg. to reduce the risk of bugs
