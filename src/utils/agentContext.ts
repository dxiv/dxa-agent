 ...
 * variables instead: DEIMOS_AGENT_ID, DEIMOS_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from DEIMOS_PARENT_SESSION_ID env var), undefined for main REPL subagents */
