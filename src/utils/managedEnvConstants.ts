 ...
 *
 * When DEIMOS_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'DEIMOS_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  'DEIMOS_USE_BEDROCK',
  'DEIMOS_USE_VERTEX',
  'DEIMOS_USE_FOUNDRY',
  ...
  'DEIMOS_SKIP_BEDROCK_AUTH',
  'DEIMOS_SKIP_VERTEX_AUTH',
  'DEIMOS_SKIP_FOUNDRY_AUTH',
 ...
 * These are Deimos specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'DEIMOS_API_KEY_HELPER_TTL_MS',
  'DEIMOS_AUTO_COMPACT_WINDOW',
  'DEIMOS_BLOCKING_LIMIT_OVERRIDE',
  'DEIMOS_DISABLE_1M_CONTEXT',
  'DEIMOS_DISABLE_EXPERIMENTAL_BETAS',
  'DEIMOS_DISABLE_NONESSENTIAL_TRAFFIC',
  'DEIMOS_DISABLE_TERMINAL_TITLE',
  'DEIMOS_ENABLE_TELEMETRY',
  'DEIMOS_EXPERIMENTAL_AGENT_TEAMS',
  'DEIMOS_FILE_READ_MAX_OUTPUT_TOKENS',
  'DEIMOS_IDE_SKIP_AUTO_INSTALL',
  'DEIMOS_MAX_CONTEXT_TOKENS',
