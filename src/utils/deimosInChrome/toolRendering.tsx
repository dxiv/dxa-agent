...
import { trackDeimosInChromeTabId } from './common.js';
...
// Avoid hard-coded shortlinks; deployments may not have a hosted portal.
const CHROME_EXTENSION_FOCUS_TAB_URL_BASE = 'about:blank';
function renderChromeToolUseMessage(input: Record<string, unknown>, toolName: ChromeToolName, verbose: boolean): React.ReactNode {
  ...
  if (typeof tabId === 'number') {
    trackDeimosInChromeTabId(tabId);
  }
