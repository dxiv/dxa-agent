export const BASE_CHROME_PROMPT = `# Deimos in Chrome browser automation
...
/**
 * Minimal hint about Deimos in Chrome skill availability. This is injected at startup when the extension is installed
