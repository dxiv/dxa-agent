...
import { getAPIMetadata } from '../services/api/anthropicMessages.js'
...
export type SideQueryOptions = {
  ...
  /** Abort signal */
  signal?: AbortSignal
  /** Skip CLI system prompt prefix (keeps attribution header for OAuth). Default true — side queries are internal classifiers with their own prompt. Set false only for queries that need the full "You are Deimos…" prefix. */
