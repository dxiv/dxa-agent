...
import { getAdditionalDirectoriesForDeimosMd } from '../../bootstrap/state.js'
import {
...
async function getWatchablePaths(): Promise<string[]> {
  ...
  for (const dir of getAdditionalDirectoriesForDeimosMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.deimos', 'skills')
    try {
