...
export function getAgentModel(
  ...
  if (process.env.DEIMOS_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.DEIMOS_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/deimos/issues/30815.
 *
