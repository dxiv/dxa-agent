...
export async function checkContextWarnings(
  ...
  const [deimosMdWarning, agentWarning, mcpWarning, unreachableRulesWarning] =
    await Promise.all([
      checkDeimosMdFiles(),
