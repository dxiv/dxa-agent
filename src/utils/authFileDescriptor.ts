 ...
 * rationale. Env var: DEIMOS_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'DEIMOS_OAUTH_TOKEN_FILE_DESCRIPTOR',
