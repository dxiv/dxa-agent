 ...
 *
 * When true:
 * - `find` and `grep` in Deimos's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering Deimos away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.DEIMOS_ENTRYPOINT
  return (
