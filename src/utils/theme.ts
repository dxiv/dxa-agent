...
const lightTheme: Theme = {
  ...
  claude: 'rgb(220,38,38)', // DXA red
  claudeShimmer: 'rgb(255,110,110)', // Lighter DXA red for shimmer effect
  ...
  briefLabelClaude: 'rgb(220,38,38)', // DXA red
...
const lightAnsiTheme: Theme = {
  ...
  /** Dimmed chrome (WelcomeV2 frame lines): darker than `subtle` on light bg — matches RGB light theme. */
  inactive: 'ansi:black',
  inactiveShimmer: 'ansi:white',
  /** Softer body (e.g. planet band): lighter than `inactive` — was same as inactive in ansi-only, so dimming vanished. */
...
const darkAnsiTheme: Theme = {
  ...
  /** Dimmed chrome (WelcomeV2 frame lines): lighter gray than `subtle` — matches RGB dark theme. */
  inactive: 'ansi:white',
  inactiveShimmer: 'ansi:whiteBright',
  /** Planet / softer body: darker than `inactive`; both were `ansi:white`, so ansi-only mode lost all dimming. */
  subtle: 'ansi:blackBright',
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(255,80,80)', // DXA red (dark theme)
  claudeShimmer: 'rgb(255,130,130)', // Lighter DXA red for shimmer effect
  ...
  briefLabelClaude: 'rgb(255,80,80)', // DXA red
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
