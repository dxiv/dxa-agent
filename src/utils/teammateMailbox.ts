 ...
 * @param teamName - Optional team name (defaults to DEIMOS_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's DEIMOS_AGENT_ID */
  workerId: string
  /** Worker's DEIMOS_AGENT_NAME */
  workerName: string
  /** Worker's DEIMOS_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to DEIMOS_TEAM_NAME env var)
