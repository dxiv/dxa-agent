...
import { bindSessionContext, type ComputerUseSessionContext, type CuPermissionRequest, type CuPermissionResponse, DEFAULT_GRANT_FLAGS, type ScreenshotDims } from '@ant/computer-use-mcp';
...
/** Narrowed shape for `bindSessionContext` results (package types are stubbed as `unknown` in ambient). */
