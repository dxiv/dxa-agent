...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so github.com/dxiv/dxa-deimos sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so github.com/dxiv/dxa-deimos doesn't show
