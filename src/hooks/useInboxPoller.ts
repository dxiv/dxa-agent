 ...
 * - Process-based teammates use their DEIMOS_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for Deimos (include color if available)
    // Transform plan approval requests to include instructions for Deimos
