/**
 * REPL integration hook for `deimos ssh` sessions.
 *
...
/** Manager returned by the ssh layer (typed for in-hook use). */
...
/** REPL-local minimal handle — matches `REPL.tsx` until the ssh module types are wired. */
...
type UseSSHSessionProps = {
  session: SSHSessionHandle | undefined
