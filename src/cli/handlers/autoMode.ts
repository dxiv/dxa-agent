...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Deimos.\n' +
  '\n' +
  'Deimos has an "auto mode" that uses an AI classifier to decide whether ' +
  ...
  if (!hasCustomRules) {
    process.stdout.write(
      'No custom auto mode rules found.\n\n' +
        ...
        'Run `deimos auto-mode defaults` to see the default rules for reference.\n',
    )
    return
  }
