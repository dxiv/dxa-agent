...
import { shouldUseDeimosCloudAuth } from './client.js'
...
export class AuthCodeListener {
  ...
  handleSuccessRedirect(
    ...
    const successUrl = shouldUseDeimosCloudAuth(scopes)
      ? getOauthConfig().DEIMOS_CLOUD_OAUTH_SUCCESS_URL
  ...
  handleErrorRedirect(): void {
    ...
    const errorUrl = getOauthConfig().DEIMOS_CLOUD_OAUTH_SUCCESS_URL
