...
import { isDeimosCloudSubscriber, getSubscriptionType } from '../../utils/auth.js'
...
import type { EnvironmentMetadata } from '../../types/generated/events_mono/deimos/v1/deimos_internal_event.js'
...
export type EnvContext = {
  ...
  isDeimosGithubProductAction: boolean
  isDeimosCloudAuth: boolean
  version: string
  versionBase?: string
  buildTime: string
...
export type FirstPartyEventLoggingMetadata = {
  ...
  process?: string
  // auth is a top-level field on DeimosInternalEvent (proto PublicApiAuth).
  // account_id is intentionally omitted — only UUID fields are populated client-side.
  auth?: PublicApiAuth
  // core fields correspond to the top level of DeimosInternalEvent.
  ...
  // DeimosInternalEvent proto. Includes but is not limited to information
...
export function to1PEventFormat(
  ...
  //   event_schemas/.../deimos/v1/deimos_internal_event.proto (wire fields unchanged)
  ...
  // parts of DeimosInternalEvent deduplicated.
  ...
  // rather than at the top level of DeimosInternalEvent
