...
/**
 * Map LSP severity to Deimos diagnostic severity
 *
 * Maps LSP severity numbers to Deimos diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Deimos diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Deimos's attachment system.
 */
 ...
 * from all LSP servers and routes them to Deimos's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Deimos format (can throw on invalid URIs)
