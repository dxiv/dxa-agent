...
/**
 * Full response from GET /api/deimos/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.deimos/settings.json',
  USER_MEMORY: '~/.deimos/DEIMOS.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.deimos/settings.local.json`,
  projectMemory: (projectId: string) =>
    `projects/${projectId}/DEIMOS.local.md`,
} as const
