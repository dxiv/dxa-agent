...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`deimos assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `deimos assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on github.com/dxiv/dxa-deimos)
  ...
  // Always-on bridge: session URL on github.com/dxiv/dxa-deimos (set when connected)
