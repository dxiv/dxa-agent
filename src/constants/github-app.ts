...
export const PR_BODY = `## 🤖 Installing Deimos GitHub App

This PR adds a GitHub Actions workflow that enables Deimos integration in our repository.
...
export const CODE_REVIEW_PLUGIN_WORKFLOW_CONTENT = `name: Deimos Review
