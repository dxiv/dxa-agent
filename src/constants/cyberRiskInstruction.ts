 ...
 *
 * This instruction provides guidance for Deimos's behavior when handling
 ...
 *   - How Deimos handles penetration testing and CTF requests
 *   - What security tools and techniques Deimos will assist with
 ...
 *
 * Deimos: Do not edit this file unless explicitly asked to do so by the user.
 */
