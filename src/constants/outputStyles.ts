...
export const OUTPUT_STYLE_CONFIG: OutputStyles = {
  ...
  Explanatory: {
    ...
    source: 'built-in',
    description:
      'Deimos explains its implementation choices and codebase patterns',
...
${EXPLANATORY_FEATURE_PROMPT}`,
  ...
  Learning: {
    ...
    source: 'built-in',
    description:
      'Deimos pauses and asks you to write small pieces of code for hands-on practice',
    keepCodingInstructions: true,
...
export async function getOutputStyleConfig(): Promise<OutputStyleConfig | null> {
  ...
  const forcedStyles = Object.values(
    allStyles as Record<string, OutputStyleConfig | null>,
  ).filter(
