...
/** Wire-shaped env block for first-party analytics (field names match upstream proto). */
...
export interface DeimosInternalEvent {
...
export const DeimosInternalEvent = {
  fromJSON(object: any): DeimosInternalEvent {
    return object ?? {}
  },

  toJSON(message: DeimosInternalEvent): unknown {
    return message ?? {}
  },

  create<I extends DeimosInternalEvent>(base?: I): DeimosInternalEvent {
    return base ?? {}
  },

  fromPartial<I extends DeimosInternalEvent>(object: I): DeimosInternalEvent {
    return object ?? {}
  },
}
