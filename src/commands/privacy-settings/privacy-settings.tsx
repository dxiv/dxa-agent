...
const FALLBACK_MESSAGE = 'Review and manage your privacy settings at https://github.com/dxiv/dxa-deimos/settings/data-privacy-controls';
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
  ...
  async function onDoneWithSettingsCheck() {
    ...
    onDone(`"Help improve Deimos" set to ${groveStatus}.`);
