 ...
 * clone/push in github.com/dxiv/dxa-deimos works immediately after this succeeds.
 */
...
/** Returns true when the user has valid Deimos OAuth credentials. */
...
export function getCodeWebUrl(): string {
  return `${getOauthConfig().DEIMOS_CLOUD_WEB_ORIGIN}/code`
}
