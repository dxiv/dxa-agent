...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/deimos.proto')
...
async function main() {
  ...
  const client = new deimosProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mDeimos gRPC CLI\x1b[0m')
