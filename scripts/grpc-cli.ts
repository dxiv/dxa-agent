...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/dxa-agent.proto')
...
const dxaAgentProto = protoDescriptor.dxaagent.v1
...
async function main() {
  ...
  const client = new dxaAgentProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mDXA Agent gRPC CLI\x1b[0m')
