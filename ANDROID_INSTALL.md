...
**Desktop / npm:** the published CLI is [**`@dxa-dev/agent`**](https://www.npmjs.com/package/@dxa-dev/agent) — use that path on Windows, macOS, or Linux instead of this Android build when you can.
